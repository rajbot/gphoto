...
static int
k_check (GPFsErr *c, const char *rb)
{
	switch ((rb[3] << 8) | rb[2]) {
	case 0x0000:
		return (0);
        case 0x0101:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Focusing error."));
		return (-1);
        case 0x0102:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Iris error."));
		return (-1);
        case 0x0201:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Strobe error."));
		return (-1);
        case 0x0203:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("EEPROM checksum error."));
		return (-1);
        case 0x0205:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Internal error (1)."));
		return (-1);
        case 0x0206:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Internal error (2)."));
		return (-1);
        case 0x0301:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("No card present."));
		return (-1);
        case 0x0311:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Card not supported."));
		return (-1);
        case 0x0321:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Card removed during access."));
		return (-1);
        case 0x0340:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Image number not valid."));
		return (-1);
        case 0x0341:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Card can not be written."));
		return (-1);
        case 0x0381:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Card is write protected."));
		return (-1);
        case 0x0382:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("No space left on card."));
		return (-1);
        case 0x0390:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Image protected."));
		return (-1);
        case 0x0401:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Light too dark."));
		return (-1);
        case 0x0402:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Autofocus error."));
		return (-1);
        case 0x0501:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("System error."));
		return (-1);
        case 0x0800:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Illegal parameter."));
		return (-1);
        case 0x0801:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Command can not be cancelled."));
		return (-1);
        case 0x0b00:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Localization data too long."));
		return (-1);
        case 0x0bff:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Localization data corrupt."));
		return (-1);
        case 0x0c01:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Unsupported command."));
		return (-1);
        case 0x0c02:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Other command executing."));
		return (-1);
        case 0x0c03:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Command order error."));
		return (-1);
        case 0x0ffff:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("Unknown error."));
		return (-1);
        default:
		gpfs_err_set (c, GPFS_ERR_TYPE_NONE, _("The camera has just sent an "
...
int
k_ping (GPPort *p, GPFsErr *c)
{
        return (l_ping (p, c));
}

int
k_init (GPPort *p, GPFsErr *c)
{
	return (l_init (p, c));
}

int
k_erase_image (GPPort *p, GPFsErr *c,
...
int
k_format_memory_card (GPPort *p, GPFsErr *c)
{
        /************************************************/
...
int
k_erase_all (GPPort *p, GPFsErr *c,
...
int
k_set_protect_status (GPPort *p, GPFsErr *c, int image_id_long,
...
int
k_get_preview (GPPort *p, GPFsErr *c, int thumbnail,
...
int
k_get_io_capability (GPPort *p, GPFsErr *c,
...
int
k_get_information (GPPort *p, GPFsErr *c, KInformation *info)
{
        /************************************************/
...
int
k_get_status (GPPort *p, GPFsErr *c, KStatus *status)
{
        /************************************************/
...
int
k_get_date_and_time (GPPort *p, GPFsErr *c, KDate *date)
{
        /************************************************/
...
int
k_get_preferences (GPPort *p, GPFsErr *c,
...
int
k_set_io_capability (GPPort *p, GPFsErr *c,
...
int
k_set_date_and_time (GPPort *p, GPFsErr *c, KDate date)
{
        /************************************************/
...
int
k_set_preference (GPPort *p, GPFsErr *c,
...
int
k_reset_preferences (GPPort *p, GPFsErr *c)
{
        /************************************************/
...
int
k_localization_tv_output_format_set (GPPort *p, GPFsErr *c,
...
int
k_localization_date_format_set (GPPort *p, GPFsErr *c,
...
int
k_localization_data_put (GPPort *p, GPFsErr *c,
...
int
k_cancel (GPPort *p, GPFsErr *c, KCommand* command)
{
        /************************************************/
