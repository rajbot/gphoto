 ...
 *
 *	Prototypes for thumbs_to_file.c
 *
 *	$Id$
 */

#ifndef _THUMBS_TO_FILE_H_
#define _THUMBS_TO_FILE_H_

int thumbs_to_file(int, int, char *, int, int);

#endif /* _THUMBS_TO_FILE_H_ */
